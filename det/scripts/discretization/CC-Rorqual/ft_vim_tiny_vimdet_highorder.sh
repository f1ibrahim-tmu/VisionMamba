...
OUTPUT_DIR=output/detection_logs/vim_tiny_rorqual_vimdet_highorder
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python det/tools/lazyconfig_train_net.py \
    ...
    # --wandb-run-name vim_tiny_vimdet_highorder_cc-rorqual \
    # --wandb-tags detection highorder cc-rorqual \
