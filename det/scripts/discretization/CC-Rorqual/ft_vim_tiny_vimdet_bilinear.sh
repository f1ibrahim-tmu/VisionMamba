#!/bin/bash
# Bilinear (Tustin) discretization for Vision Mamba detection on MS-COCO
#
# Usage: ./ft_vim_tiny_vimdet_bilinear.sh [DATASET_PATH]
...
OUTPUT_DIR="${OUTPUT_ROOT}/detection_logs/vim_tiny_rorqual_vimdet_bilinear"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python det/tools/lazyconfig_train_net.py \
    ...
    # --wandb-run-name vim_tiny_vimdet_bilinear_cc-rorqual \
    # --wandb-tags detection bilinear cc-rorqual \
