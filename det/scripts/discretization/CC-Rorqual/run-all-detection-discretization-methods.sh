...
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_vimdet_zoh.sh

echo "Running First Order Hold (FOH) training..."
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_vimdet_foh.sh

echo "Running Bilinear (Tustin) Transform training..."
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_vimdet_bilinear.sh

echo "Running Polynomial Interpolation training..."
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_vimdet_poly.sh

echo "Running Higher-Order Hold training..."
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_vimdet_highorder.sh

echo "Running RK4 training..."
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_vimdet_rk4.sh
