...
train.init_checkpoint = f"{_out}/detection_logs/vim_tiny_vimdet_highorder/checkpoint.pth"
...
model.backbone.net.pretrained = f"{_out}/classification_logs/vim_tiny_highorder/best_checkpoint.pth"
