...
train.init_checkpoint = f"{_out}/detection_logs/vim_tiny_vimdet_poly/checkpoint.pth"
...
model.backbone.net.pretrained = f"{_out}/classification_logs/vim_tiny_poly/best_checkpoint.pth"
