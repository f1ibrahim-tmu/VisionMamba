...
train.init_checkpoint = f"{_out}/detection_logs/vim_tiny_vimdet_bilinear/checkpoint.pth"
...
model.backbone.net.pretrained = f"{_out}/classification_logs/vim_tiny_bilinear/best_checkpoint.pth"
