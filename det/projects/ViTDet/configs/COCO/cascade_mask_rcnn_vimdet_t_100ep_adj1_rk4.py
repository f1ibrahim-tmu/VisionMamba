...
train.init_checkpoint = f"{_out}/detection_logs/vim_tiny_vimdet_rk4/checkpoint.pth"
...
model.backbone.net.pretrained = f"{_out}/classification_logs/vim_tiny_rk4/best_checkpoint.pth"
