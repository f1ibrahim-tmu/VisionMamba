...
#
# Usage: ./ft_vim_tiny_upernet_bilinear.sh [DATASET_PATH]
...
WORK_DIR="${OUTPUT_ROOT}/segmentation_logs/vim_tiny_rorqual_vimseg_upernet_bilinear"
RESUME_ARG=""
CHECKPOINT_PATH=""
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.run --standalone --nproc_per_node=4 --master_port=$MASTER_PORT \
    ...
    # --wandb-run-name vim_tiny_upernet_bilinear_cc-rorqual \
    # --wandb-tags segmentation bilinear cc-rorqual \
