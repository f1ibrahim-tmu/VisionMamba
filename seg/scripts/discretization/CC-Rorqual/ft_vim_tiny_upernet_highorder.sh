...
PRETRAIN_CKPT="${OUTPUT_ROOT}/classification_logs/vim_tiny_highorder/best_checkpoint.pth"

# 3. Resume Logic
# MMEngine saves checkpoints as latest.pth, iter_*.pth, or custom names
WORK_DIR="${OUTPUT_ROOT}/segmentation_logs/vim_tiny_rorqual_vimseg_upernet_highorder"
RESUME_ARG=""
CHECKPOINT_PATH=""
