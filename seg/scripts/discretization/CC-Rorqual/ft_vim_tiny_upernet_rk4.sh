...
PRETRAIN_CKPT=/home/f7ibrahi/links/projects/def-wangcs/f7ibrahi/projects/VisionMamba/output/vim_tiny_rk4/best_checkpoint.pth
...
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.run --nproc_per_node=2 --master_port $MASTER_PORT \
    ...
    ${SEG_CONFIG} \
    --seed 0 --work-dir ./output/segmentation_logs/vim_tiny_vimseg_upernet_rk4 --deterministic \
