...
#
# Usage: ./ft_vim_tiny_upernet_rk4.sh [DATASET_PATH]
...
SEG_CONFIG=seg/configs/vim/upernet/upernet_vim_tiny_24_512_slide_200k_rk4.py
PRETRAIN_CKPT="${OUTPUT_ROOT}/classification_logs/vim_tiny_rk4/best_checkpoint.pth"

# 3. Resume Logic
# MMEngine saves checkpoints as latest.pth, iter_*.pth, or custom names
WORK_DIR="${OUTPUT_ROOT}/segmentation_logs/vim_tiny_rorqual_vimseg_upernet_rk4"
RESUME_ARG=""
CHECKPOINT_PATH=""
