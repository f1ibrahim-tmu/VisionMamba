...
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_upernet_zoh.sh

echo "Running First Order Hold (FOH) training..."
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_upernet_foh.sh

echo "Running Bilinear (Tustin) Transform training..."
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_upernet_bilinear.sh

echo "Running Polynomial Interpolation training..."
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_upernet_poly.sh

echo "Running Higher-Order Hold training..."
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_upernet_highorder.sh

echo "Running RK4 training..."
bash ./scripts/discretization/CC-Rorqual/ft_vim_tiny_upernet_rk4.sh
