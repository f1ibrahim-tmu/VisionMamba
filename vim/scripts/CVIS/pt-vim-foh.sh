...
watch -n 28800 -t 'nvidia-smi >> ./output/vim_tiny_foh/gpu.log'

# PyTorch memory every 8 hours
watch -n 28800 -t 'python -c "import torch; print(torch.cuda.memory_summary())" >> ./output/vim_tiny_foh/torch_mem.log'
