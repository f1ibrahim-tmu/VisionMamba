...
def compute_statistics(method_name, seeds, base_dir="./output/classification_logs/cifar100"):
...
def main():
    ...
    parser.add_argument('--base-dir', type=str, default='./output/classification_logs/cifar100',
                       help='Base directory for output logs (default: ./output/classification_logs/cifar100)')
