...
watch -n 28800 -t 'nvidia-smi >> ./output/vim_tiny_rk4/vim_tiny_rk4_gpu.log'
...
# watch -n 28800 -t 'python -c "import torch; print(torch.cuda.memory_summary())" >> ./output/vim_tiny_rk4_torch_mem.log'