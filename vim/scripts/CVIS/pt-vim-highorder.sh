...
watch -n 28800 -t 'nvidia-smi >> ./output/vim_tiny_highorder/vim_tiny_highorder_gpu.log'
...
# watch -n 28800 -t 'python -c "import torch; print(torch.cuda.memory_summary())" >> ./output/vim_tiny_highorder_torch_mem.log'
