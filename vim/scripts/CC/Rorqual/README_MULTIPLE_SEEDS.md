...
- `Rorqual_pt-vim-foh.sh`
- `Rorqual_pt-vim-bilinear.sh`
- `Rorqual_pt-vim-poly.sh`
- `Rorqual_pt-vim-highorder.sh`
- `Rorqual_pt-vim-rk4.sh`
...
```bash
bash ./scripts/CC/Rorqual/Rorqual_pt-vim-zoh.sh
```

**Run with specific seed:**
```bash
bash ./scripts/CC/Rorqual/Rorqual_pt-vim-zoh.sh 1
bash ./scripts/CC/Rorqual/Rorqual_pt-vim-zoh.sh 2
```
...
**Script**: `Rorqual_run-single-method-seeds.sh`

Run a single discretization method with multiple seeds:

```bash
# Run ZOH with default seeds (0,1,2,3,4)
bash ./scripts/CC/Rorqual/Rorqual_run-single-method-seeds.sh zoh

# Run HighOrder with custom seeds
bash ./scripts/CC/Rorqual/Rorqual_run-single-method-seeds.sh highorder 0,1,2,3,4
...
**Script**: `Rorqual_run-multiple-seeds.sh`

Run all discretization methods with multiple seeds sequentially:

```bash
bash ./scripts/CC/Rorqual/Rorqual_run-multiple-seeds.sh
```
...
python ./scripts/CC/Rorqual/extract_results.py

# Extract results for a specific method
python ./scripts/CC/Rorqual/extract_results.py --method zoh
python ./scripts/CC/Rorqual/extract_results.py --method highorder

# Use custom seeds
python ./scripts/CC/Rorqual/extract_results.py --method zoh --seeds 0,1,2,3,4

# Custom base directory
python ./scripts/CC/Rorqual/extract_results.py --base-dir ./output/classification_logs
```
...
- Saves summary to `./output/classification_logs/results_summary.json`
...
bash ./scripts/CC/Rorqual/Rorqual_run-single-method-seeds.sh zoh
bash ./scripts/CC/Rorqual/Rorqual_run-single-method-seeds.sh foh
# ... etc
```
...
- **Solution**: Modify the `SEEDS` array in `Rorqual_run-multiple-seeds.sh` or pass custom seeds to `Rorqual_run-single-method-seeds.sh`
