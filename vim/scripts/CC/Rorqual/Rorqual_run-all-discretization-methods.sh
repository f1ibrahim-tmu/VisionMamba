...
bash ./scripts/CC/Rorqual/Rorqual_pt-vim-foh.sh

echo "Running Bilinear (Tustin) Transform training..."
bash ./scripts/CC/Rorqual/Rorqual_pt-vim-bilinear.sh

echo "Running Polynomial Interpolation training..."
bash ./scripts/CC/Rorqual/Rorqual_pt-vim-poly.sh

echo "Running Higher-Order Hold training..."
bash ./scripts/CC/Rorqual/Rorqual_pt-vim-highorder.sh

echo "Running Runge-Kutta 4th Order (RK4) training..."
bash ./scripts/CC/Rorqual/Rorqual_pt-vim-rk4.sh
