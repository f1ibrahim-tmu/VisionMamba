...
# Feature-StabEnforce: Baseline (no stabilizers)
...
echo "Running Baseline (no stabilizers) with seed $SEED"
...
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.run --nproc_per_node=2 --master_port $MASTER_PORT \
    ...
    --seed $SEED \
    --output_dir /home/f7ibrahi/links/projects/def-wangcs/f7ibrahi/projects/VisionMamba/output/classification_logs/vim_tiny_zoh_stab_baseline_seed${SEED} \
    --resume /home/f7ibrahi/links/projects/def-wangcs/f7ibrahi/projects/VisionMamba/output/classification_logs/vim_tiny_zoh_stab_baseline_seed${SEED}/checkpoint.pth
