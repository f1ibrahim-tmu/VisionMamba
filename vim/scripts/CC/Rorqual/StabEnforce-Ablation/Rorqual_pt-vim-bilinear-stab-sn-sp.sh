...
# Feature-StabEnforce: Spectral Normalization + Stability Penalty - Bilinear discretization
...
echo "Running Spectral Normalization + Stability Penalty with Bilinear discretization, seed $SEED"
...
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.run --nproc_per_node=2 --master_port $MASTER_PORT \
    ...
    --use-stability-penalty \
    --stability-epsilon 0.01 \
    --stability-penalty-weight 0.1 \
    --output_dir /home/f7ibrahi/links/projects/def-wangcs/f7ibrahi/projects/VisionMamba/output/classification_logs/vim_tiny_bilinear_stab_sn_sp_seed${SEED} \
    --resume /home/f7ibrahi/links/projects/def-wangcs/f7ibrahi/projects/VisionMamba/output/classification_logs/vim_tiny_bilinear_stab_sn_sp_seed${SEED}/checkpoint.pth
